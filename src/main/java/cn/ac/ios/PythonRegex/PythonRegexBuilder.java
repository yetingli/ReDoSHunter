...
public final class PythonRegexBuilder {
    ...
    public static final class Lexer {
        ...
        public Lexer(ANTLRInputStream input) {
            this.lexer = new PythonRegexLexer(input);
    ...
    public static final class Parser {
        ...
        private PythonRegexParser parser;
        ...
        public Parser(ANTLRInputStream input) {
            PythonRegexLexer lexer = new PythonRegexLexer(input);
            lexer.removeErrorListeners();
            lexer.addErrorListener(ERROR_LISTENER);
            this.parser = new PythonRegexParser(new CommonTokenStream(lexer));
            this.parser.removeErrorListeners();
            this.parser.addErrorListener(ERROR_LISTENER);
        }

        public Parser(PythonRegexLexer lexer) {
            this.parser = new PythonRegexParser(new CommonTokenStream(lexer));
            this.parser.removeErrorListeners();
            this.parser.addErrorListener(ERROR_LISTENER);
        }
        ...
        public PythonRegexParser build() {
            return this.parser;
        }
    }
    ...
    public static final class Tree {
        ...
        public String toStringASCII() {
            ...
            PythonRegexParser parser = new Parser(input).build();
...
//        System.out.println(new Builder.Tree(regex).toStringASCII());
        ...
        PythonRegexParser parser = new Parser(regex).build();
        ParseTree tree = parser.parse();
