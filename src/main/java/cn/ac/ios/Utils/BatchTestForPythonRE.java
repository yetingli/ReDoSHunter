...
public class BatchTestForPythonRE {
    ...
    public static void generatePythonREFile(String datasetName, String regex, ReDoSBean reDosBean, String attackFunctionName, String path) {
        int count = 0;
        File file = null;
...
//            newlyttree.rewriteIllegalBarSymbol();
        ...
        formatRegex = formatRegex.replace("\\d{5}+", "\\d{5}")
                .replace("\\w*+", "\\w*")
                .replace("\\h", "h")
                .replace("?>", "?:");
    ...
    public static void generatePythonREFile(String datasetName, String regex, ReDoSBean reDosBean, String attackFunctionName) {
        generatePythonREFile(datasetName, regex, reDosBean, attackFunctionName, "");
    }
